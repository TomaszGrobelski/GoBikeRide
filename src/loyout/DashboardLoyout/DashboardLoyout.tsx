...
const DashboardLoyout = ({ children }: IDashboardLayout) => {
    ...
    const sectionName = sectionNames[(router.split('/').pop() as keyof typeof sectionNames) || ''];
    ...
    //  ${theme === 'light' ? 'bg-lightBackground' : 'bg-[#030014]'}
    return (
        <div className={`relative flex min-h-full bg-lightBackground font-poppins`}>
