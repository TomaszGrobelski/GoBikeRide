...
const ErrorCard = ({ refetch }: IErrorCard) => {
  return (
    <div className='flex h-1/2 flex-col items-center justify-center'>
      <div className='border-mainPurple flex flex-col items-center justify-center gap-6 rounded-lg border-[1px] p-10'>
        ...
        <button
          onClick={refetch}
          className='bg-mainPurple rounded-full border-[1px] p-2 text-white'
        >
          Spróbuj ponownie
        </button>
      </div>
