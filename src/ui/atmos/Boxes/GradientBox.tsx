...
const GradientBox = ({ children }: IGradientBox) => {
  return (
    <div className='w-ful max-w-[1100px] relative z-10 flex min-h-[500px] flex-col items-center justify-center gap-10 overflow-hidden rounded-3xl bg-custom-gradient'>
